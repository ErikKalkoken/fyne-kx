...
func NewSnackbar(c fyne.Canvas) *Snackbar {
	text := &widget.RichText{Scroll: container.ScrollNone}
...
func (sb *Snackbar) show(text string) {
	...
	sb.text.Segments = []widget.RichTextSegment{
		&widget.TextSegment{Text: text, Style: widget.RichTextStyle{ColorName: snackbarColorNameForeground}},
	}
...
func (sb *Snackbar) animateShow(finalSize fyne.Size, finalPos fyne.Position) {
	...
	r, g, b, _ := toNRGBA(theme.Color(snackbarColorNameBackground))
